...
class Config:
    ...
    # 模型链(两个字段同构): task.params 覆盖 > env 显式覆盖 > relay
    # /v1/internal/models/preferred?mode=<chat|audio_transcription> 自动优选
    # > 任务明确报错 (无内置硬编码兜底)。
    ...
    def from_env(cls, env: dict | None = None) -> "Config":
        ...
        return cls(
            ...
            hotparse_stt_model=e.get("AIGC_HOTPARSE_STT_MODEL", ""),
