...
void main() {
  test('v29 旧库迁移到 v30：五表加 owner_key 列且存量行全部清空', () async {
    ...
    // ── 3. 断言 ──
    expect(raw.userVersion, 37, reason: '迁移后 schema 版本应为 37（v31/v32 加 chat_sync_state / chat_outbox，v33 笔记五表加 owner_key，v34 清 sse_cursors，v37 chat_content_blocks 加 form_payload_json）');
